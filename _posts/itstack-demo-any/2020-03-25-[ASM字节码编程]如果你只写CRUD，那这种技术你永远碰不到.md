...
title: ASM字节码编程 | 如果你只写CRUD，那这种技术你永远碰不到
tagline: by 付政委
...
为了更方便的学习```ASM```，我将《ASM4使用手册》以及一些技术点整理成在线文档，可以随时方便查阅([http://asm.itstack.org](http://asm.itstack.org/))；

![ASM4使用手册](https://fuzhengwei.github.io/assets/images/2020/itstack-demo-asm-01-1.png)
...
![ASM4使用手册](https://fuzhengwei.github.io/assets/images/2020/itstack-demo-asm-01-4.png)
...
1. 安装插件(ASM Bytecode Outline)
   ...
   ![安装插件(ASM Bytecode Outline)](https://fuzhengwei.github.io/assets/images/2020/itstack-demo-asm-01-2.png)	
	

2. 测试使用

   ![测试使用(ASM Bytecode Outline)](https://fuzhengwei.github.io/assets/images/2020/itstack-demo-asm-01-3.png)	
